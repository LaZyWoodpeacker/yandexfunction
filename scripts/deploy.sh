...
yc serverless function version create \
  ...
  --environment YDB_ENDPOINT=$YDB_ENDPOINT,YDB_DATABASE=$YDB_DATABASE,YF_BOT_KEY=$YF_BOT_KEY,YF_BOT_MYNAME=$YF_BOT_MYNAME,YDB_METADATA_CREDENTIALS=1,GITHUB_KEY=$GITHUB_KEY,GITHUB_USERNAME=$GITHUB_USERNAME \
